...
function NoAccessCard() {
  ...
  return (
    <div className="text-center py-10">
        ...
        <h3 className="font-bold">{t('access_denied')}</h3>
        <p className="text-muted-foreground">{t('no_super_admin_permission_orders')}</p>
    </div>
  );
}

function SuperAdminOrdersTable() {
...
export default function AllOrdersPage() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t('all_orders')}</CardTitle>
        <CardDescription>{t('all_orders_desc')}</CardDescription>
      </CardHeader>
      <CardContent>
        {isAdminLoading ? (
